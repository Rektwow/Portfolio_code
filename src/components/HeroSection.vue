<template>
  <section class="relative w-full" data-aos="zoom-in-up">
    <div class="absolute top-0 inset-x-0 h-64 flex items-start">
      <div
        class="h-24 w-2/3 bg-gradient-to-br from-primary blur-2xl invisible opacity-40"
      ></div>
      <div
        class="h-20 w-3/5 bg-gradient-to-l from-secondary opacity-40 blur-2xl"
      ></div>
    </div>
    <div
      class="w-full px-5 sm:px-8 md:px-12 lg:px-8 max-w-screen-lg lg:max-screen-xl mx-auto relative"
    >
      <div
      ...
      >
        <div class="lg:py-1">
          ...
          >
            ...
            alias vero, omnis est non eius esse excepturi repellendus quisquam
            tempora nisi nam in voluptatum.
          </p>
          <div
          ...
          >
            ...
            >
              ...
              ></span>
              <span class="relative flex items-center justify-center text-black"
                >Hire Me</span
              >
            </button>
            <button
        ...
        <div class="lg:h-full md:flex">
          ...
          >
            <div
              class="absolute z-0 top-1/2 -translate-y-1/2 w-5/6 right-0 h-[calc(80%+20px)] bg-gradient-to-tr opacity-25 from-secondary to-primary blur-2xl"
            ></div>
            <div
              class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-4 sm:right-16 rounded-full shadow-lg border border-primary"
            >
              <img
