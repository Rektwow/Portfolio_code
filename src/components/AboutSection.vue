<template>
  <section class="text-white mt-18" id="about">
    ...
    <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z1">
      <div data-aos="flip-right">
        <h2 class="text-4xl font-bold text-white text-left mb-8">My Education</h2>
        <div class="space-y-8 py-8">
          <div v-for="element in education" :key="element.id" class="flex items-center md:w-[80%] w-full rounded-xl bg-[#111a3e] shadow-lg border border-[#f59e0b]">
            <div class="w-1/4">
      ...
      <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
        <h2 class="text-4xl font-bold text-white md:text-left mb-4">
          More
        ...
        <p class="text-base lg:text-lg mt-8 py-8">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia sint earum aspernatur deleniti mollitia qui. Ab, error culpa, at enim officia suscipit dolorem, expedita perspiciatis aliquid ducimus inventore eveniet ipsum veritatis
          amet repellat illo. Minima voluptas dolor aliquid non saepe magnam rerum dolorem possimus quas ad error laudantium, laborum consectetur!
        </p>
        <div class="grid grid-cols-3 gap-4 max-w-lg pt-8">
          <div class="text-center rounded-xl bg-[#111a3e] shadow-lg border border-[#f59e0b] p-3">
