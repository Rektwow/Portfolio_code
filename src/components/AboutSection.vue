<template>
  <section class="text-white mt-18" id="about">
    ...
    <div
      class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z1"
    >
      ...
      >
        ...
        <p class="text-base lg:text-lg mt-8 py-8">
          ...
          earum aspernatur deleniti mollitia qui. Ab, error culpa, at enim
          officia suscipit dolorem, expedita perspiciatis aliquid ducimus
          inventore eveniet ipsum veritatis amet repellat illo. Minima voluptas
          dolor aliquid non saepe magnam rerum dolorem possimus quas ad error
          laudantium, laborum consectetur!
        </p>
